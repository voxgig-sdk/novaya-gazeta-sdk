...
const testSeed = `map[string]any{"entity": map[string]any{"article": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "theme": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
