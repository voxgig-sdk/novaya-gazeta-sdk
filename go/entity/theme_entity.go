...
func NewThemeEntity(client *core.NovayaGazetaSDK, entopts map[string]any) *ThemeEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ThemeEntity) GetName() string { return e.name }
...
func (e *ThemeEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ThemeEntity) Deleted() bool {
	return e.deleted
}


func (e *ThemeEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewThemeEntity(e.client, opts)
}

func (e *ThemeEntity) Data(args ...any) any {
...
func (e *ThemeEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Theme; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ThemeEntity) DataTyped(data ...Theme) Theme {
	if len(data) > 0 {
		return typedFrom[Theme](e.Data(asMap(data[0])))
	}
	return typedFrom[Theme](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Theme (all fields
// optional at the wire level).
func (e *ThemeEntity) MatchTyped(match ...Theme) Theme {
	if len(match) > 0 {
		return typedFrom[Theme](e.Match(asMap(match[0])))
	}
	return typedFrom[Theme](e.Match())
}
...
func (e *ThemeEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ThemeEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *ThemeEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ThemeListMatch and returns []Theme. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *ThemeEntity) ListTyped(reqmatch ThemeListMatch, ctrl map[string]any) ([]Theme, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Theme](res), nil
}



func (e *ThemeEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ThemeEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ThemeEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ThemeEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
