...
// NovayaGazeta SDK timeout feature
...
class NovayaGazetaTimeoutFeature extends NovayaGazetaBaseFeature
{
    ...
    private function _with_timeout(NovayaGazetaContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(NovayaGazetaContext $_ctx, float $ms): void
    {
        $client = $this->client;
