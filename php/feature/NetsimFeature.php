...
// NovayaGazeta SDK netsim feature
...
class NovayaGazetaNetsimFeature extends NovayaGazetaBaseFeature
{
    ...
    private function _simulate(NovayaGazetaContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(NovayaGazetaContext $ctx, array $applied): void
    {
        $client = $this->client;
