...
// NovayaGazeta SDK metrics feature
...
class NovayaGazetaMetricsFeature extends NovayaGazetaBaseFeature
{
    ...
    private function _record(NovayaGazetaContext $ctx, bool $ok): void
    {
