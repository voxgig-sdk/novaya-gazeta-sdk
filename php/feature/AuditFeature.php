...
// NovayaGazeta SDK audit feature
...
class NovayaGazetaAuditFeature extends NovayaGazetaBaseFeature
{
    ...
    private function _emit(NovayaGazetaContext $ctx, string $outcome): void
    {
