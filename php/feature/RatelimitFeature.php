...
// NovayaGazeta SDK ratelimit feature
...
class NovayaGazetaRatelimitFeature extends NovayaGazetaBaseFeature
{
    ...
    private function _acquire(NovayaGazetaContext $ctx): void
    {
    ...
    private function _track(NovayaGazetaContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
