...
// NovayaGazeta SDK proxy feature
...
class NovayaGazetaProxyFeature extends NovayaGazetaBaseFeature
{
    ...
    public function init(NovayaGazetaContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (NovayaGazetaContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
