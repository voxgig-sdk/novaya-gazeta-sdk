...
// NovayaGazeta SDK cache feature
...
class NovayaGazetaCacheFeature extends NovayaGazetaBaseFeature
{
    ...
    private function _through(NovayaGazetaContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
