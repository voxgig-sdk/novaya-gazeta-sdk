...
// NovayaGazeta SDK telemetry feature
...
class NovayaGazetaTelemetryFeature extends NovayaGazetaBaseFeature
{
    ...
    private function _close(NovayaGazetaContext $ctx, bool $ok): void
    {
