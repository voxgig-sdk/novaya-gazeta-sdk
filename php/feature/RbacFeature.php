...
class NovayaGazetaRbacFeature extends NovayaGazetaBaseFeature
{
    ...
    private function _required(NovayaGazetaContext $ctx): ?string
    {
    ...
    private function _reject(NovayaGazetaContext $ctx, string $required): void
    {
    ...
    private function _track(NovayaGazetaContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
