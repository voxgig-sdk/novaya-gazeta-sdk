...
// NovayaGazeta SDK clienttrack feature
...
class NovayaGazetaClienttrackFeature extends NovayaGazetaBaseFeature
{
    ...
    public function PostConstruct(NovayaGazetaContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'NovayaGazeta-SDK';
