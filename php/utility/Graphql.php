...
// NovayaGazeta SDK utility: graphql
//
...
class NovayaGazetaGraphql
{
    ...
    // equivalent.
    public static function body(NovayaGazetaContext $ctx): mixed
    {
    ...
    public static function errors(NovayaGazetaContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
