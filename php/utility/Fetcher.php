...
// NovayaGazeta SDK utility: fetcher

class NovayaGazetaFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; NovayaGazetaSDK/1.0)';
    ...
    public static function call(NovayaGazetaContext $ctx, string $fullurl, array $fetchdef): array
    {
