...
// NovayaGazeta SDK utility: make_options

class NovayaGazetaMakeOptions
{
    ...
    public static function call(NovayaGazetaContext $ctx): array
    {
        ...
        //
        // `NovayaGazetaSchema::optspec()` is built from the model:
        ...
        $optspec = NovayaGazetaSchema::optspec();
