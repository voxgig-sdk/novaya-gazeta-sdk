...
// NovayaGazeta SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (NovayaGazetaSDK::test)
...
{
    private const SDK_CLASS = 'NovayaGazetaSDK';
    ...
    private const SDK_BASE = 'novayagazeta_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../novayagazeta_sdk.php';
