...
func registerSDKWords(r *eng.Registry, client *sdk.NovayaGazetaSDK) {
...
func runOp(client *sdk.NovayaGazetaSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
