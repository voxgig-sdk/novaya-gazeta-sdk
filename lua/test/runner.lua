...
function runner.env_override(m)
  local live = runner.getenv("NOVAYAGAZETA_TEST_LIVE")
  local override = runner.getenv("NOVAYAGAZETA_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("NOVAYAGAZETA_TEST_EXPLAIN")
