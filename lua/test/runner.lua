...
function runner.env_override(m)
  local live = runner.getenv("NOVAYA_GAZETA_TEST_LIVE")
  local override = runner.getenv("NOVAYA_GAZETA_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("NOVAYA_GAZETA_TEST_EXPLAIN")
