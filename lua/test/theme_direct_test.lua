...
describe("ThemeDirect", function()
  it("should direct-list-theme", function()
    local setup = theme_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-theme", setup.live and "live" or "unit")
