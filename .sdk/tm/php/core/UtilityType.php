...
// NovayaGazeta SDK utility type

class NovayaGazetaUtility
{
    ...
    public static function copy(NovayaGazetaUtility $src): NovayaGazetaUtility
    {
        $u = new NovayaGazetaUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
