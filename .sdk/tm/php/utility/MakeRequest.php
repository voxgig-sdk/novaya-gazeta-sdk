...
// NovayaGazeta SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class NovayaGazetaMakeRequest
{
    public static function call(NovayaGazetaContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new NovayaGazetaResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new NovayaGazetaResponse($fetched);
        } else {
