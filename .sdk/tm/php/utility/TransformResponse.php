...
// NovayaGazeta SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class NovayaGazetaTransformResponse
{
    public static function call(NovayaGazetaContext $ctx): mixed
    {
        ...
        $transform = NovayaGazetaHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
