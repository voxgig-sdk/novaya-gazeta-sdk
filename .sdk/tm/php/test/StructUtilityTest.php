...
// NovayaGazeta SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = NovayaGazetaOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(NovayaGazetaOmni::structfix($now, Struct::undef()))
                        !== json_encode(NovayaGazetaOmni::structfix($val, Struct::undef()))) {
