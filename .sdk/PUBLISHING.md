...
|---|---|---|
| `ts/` | @voxgig-sdk/novaya-gazeta-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/novaya-gazeta-sdk \
      --repository voxgig-sdk/novaya-gazeta-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/novaya-gazeta-sdk` shows it, and
`npm trust revoke @voxgig-sdk/novaya-gazeta-sdk --id=<id>` removes it.
