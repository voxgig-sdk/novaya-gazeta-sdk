...
(0, node_test_1.describe)('ThemeDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.NovayaGazetaSDK({
    ...
    (0, node_test_1.test)('direct-list-theme', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-theme', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.NOVAYA_GAZETA_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.NovayaGazetaSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['NOVAYA_GAZETA_TEST_THEME_ENTID'];
    ...
    const client = new __1.NovayaGazetaSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=ThemeDirect.test.js.map