...
(0, node_test_1.describe)('ThemeEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['list']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'theme.' + op, live))
                return;
        }
        ...
        let theme_ref01_data = Object.values(setup.data.existing.theme)[0];
        // LIST
...
function basicSetup(extra) {
    ...
    const idmapEnvVal = process.env['NOVAYA_GAZETA_TEST_THEME_ENTID'];
