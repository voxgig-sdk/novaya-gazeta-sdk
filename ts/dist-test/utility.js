...
function envOverride(m) {
    if ('TRUE' === process.env.NOVAYA_GAZETA_TEST_LIVE ||
        'TRUE' === process.env.NOVAYA_GAZETA_TEST_OVERRIDE) {
    ...
    m.NOVAYA_GAZETA_TEST_EXPLAIN = process.env.NOVAYA_GAZETA_TEST_EXPLAIN || m.NOVAYA_GAZETA_TEST_EXPLAIN;
    return m;
}
