...
type Args struct {
	Entity string         `json:"entity" jsonschema:"article | theme"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.NovayaGazetaSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "novaya-gazeta_list",
		Description: "List records from NovayaGazeta. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "novaya-gazeta_load",
		Description: "Load a single record from NovayaGazeta. " +
...
func runOp(client *sdk.NovayaGazetaSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.NovayaGazetaSDK, name string) (sdk.NovayaGazetaEntity, error) {
	switch strings.ToLower(name) {
	case "article":
		return client.Article(nil), nil
	case "theme":
		return client.Theme(nil), nil
