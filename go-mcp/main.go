// Command NovayaGazeta-mcp is an MCP server exposing the NovayaGazeta
// SDK as MCP tools.
//
// Two tools are registered:
//
//	NovayaGazeta_list  — list records of an entity
//	NovayaGazeta_load  — load a single record of an entity
//
