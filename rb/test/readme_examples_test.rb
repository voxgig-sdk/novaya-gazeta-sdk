...
#      offline in seeded test mode (NovayaGazetaSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "NovayaGazeta_sdk.rb")
  SDK_CLASS = "NovayaGazetaSDK"
