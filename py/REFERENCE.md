# NovayaGazeta Python SDK Reference

Complete API reference for the NovayaGazeta Python SDK.
...
#### `NovayaGazetaSDK.test(testopts=None, sdkopts=None)`
...
Create a new `ThemeEntity` instance. Pass `None` for no initial data.
...
```python
results = client.Article().list({"slug": []})
...
Create a new `ThemeEntity` instance with the same options.
