# NovayaGazeta Python SDK



The Python SDK for the NovayaGazeta API — an entity-oriented client following Pythonic conventions.
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/novaya-gazeta-sdk/releases)) or
...
```python
try:
    articles = client.Article().list({"slug": []})
...
client = NovayaGazetaSDK(options)
```
...
```
py/
├── novayagazeta_sdk.py         -- Main SDK module
