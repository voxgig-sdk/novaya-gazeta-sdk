...
from novayagazeta_sdk.utility import register

# Load features
from novayagazeta_sdk.feature.base_feature import NovayaGazetaBaseFeature
from novayagazeta_sdk.features import _has_feature, _make_feature
...
class NovayaGazetaSDK:
    ...
    def get_utility(self):
        return NovayaGazetaUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("NovayaGazetaSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Article(self, data=None) -> "ArticleEntity":
        ...
        from novayagazeta_sdk.entity.article_entity import ArticleEntity
        return ArticleEntity(self, data)


    def Theme(self, data=None) -> "ThemeEntity":
        """Entity factory: client.Theme().list() / client.Theme().load({"id": ...})."""
        from novayagazeta_sdk.entity.theme_entity import ThemeEntity
        return ThemeEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "NovayaGazetaSDK":
        if sdkopts is None:
            sdkopts = {}
