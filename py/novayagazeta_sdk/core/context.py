...
from novayagazeta_sdk.core.helpers import get_ctx_prop, to_map
...
class NovayaGazetaContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, NovayaGazetaSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, NovayaGazetaResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, NovayaGazetaResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return NovayaGazetaError(code, msg, self)
