...
class NovayaGazetaTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = NovayaGazetaTestRunner.getenv("NOVAYAGAZETA_TEST_LIVE")
        override = NovayaGazetaTestRunner.getenv("NOVAYAGAZETA_TEST_OVERRIDE")
        ...
        explain = NovayaGazetaTestRunner.getenv("NOVAYAGAZETA_TEST_EXPLAIN")
